...
/**
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 * 讀取本地json檔案文件，并執行主函數main()
 * maplist.json -> 本地文件，用於放置儲存的map圖片名稱和對應的icon位置
 * device_and_port.json -> 本地文件，用於放置監控器的 Web Url 信息
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 */
 ...
 * initial初始化動作
 * 讀取服務器本地檔案
 * 主頁面顯示Map名稱以及地圖對應的監控器icon圖標
 * 
 * @Addmaps()：使用讀取到的資料來創建map
 * @HideRmenu()：點擊網頁任何地方即隱藏自訂右鍵選單
 * @SelectIcon()：當icon button被按下時觸發，滑鼠會變成icon的樣子，以便把icon插在map上
 * @ScreenZoomIn()：顯示監控器傳輸的畫面
 * @ScreenZoomOut()：放大監控器傳輸的畫面
 * @ShowDeivceStatus()：顯示監控器圖標的開關狀態
 * @startTime()：顯示系統當前時間
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 */
...
/**
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 * Addmaps()功能為:使用讀取到的json檔案資料創建地圖
 * 
 * @ClearIconList():清空所有選取地圖物件div中的innerHTML
 * @AddIcons():根據jsonData的資料創建該地圖的Icons
 * @ShowClassList()：更新左側地圖下面的圖標信息
 * @ShowDeivceStatus()：對於地圖上的每個icon，都發送request到server，並且根據server的response來改變icon顏色，點擊地圖名稱和點擊刷新按鈕都會觸發這個function
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 */
...
/**
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 * ClearIconList()功能為:清除所有顯示的iconlist
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 */
...
/**
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 * AddIcons()功能為:先清空原本的圖標，然後遍歷服務器本地json中當前地圖下的圖標資訊，在圖中塞入已經存好的圖標
 * 
 * @CreateIcon()：根據傳入的icons各欄位資料創建Icon
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 */
...
/**
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 * CreateIcon()功能為:根據傳入的參數（如x、y軸坐標、名稱、url資訊等），把圖標插入地圖中
 * 
 * 雙擊事件：輸出監控器url畫面
 * 右鍵單擊事件：進入圖標icon編輯表單功能
 * 
 * @showrightmenu()
 * @AddRmenuEvent()
 * @HideRmenu()
...
/**
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 * 以下為Container部分，預設右鍵選單界面設計
 * 
 * @showrightmenu()：顯示移動刪除選單
 * @AddRmenuEvent()：設定'移動','刪除'之物件事件
 * @MoveElement()：設定'移動'事件
 * @HideRmenu()：隱藏右鍵選單，點擊網頁任意地方觸發(在main中設定)
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 */ 
...
/**
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 * ShowClassList()功能為:左方樹狀地圖的選單點擊後會先出現這個地圖的設備種類
 * event: when "map btn" OnClick
 * active: show "icon kinds" on left side
 * 
 * @ClearClassIconList()：清除所有顯示的iconlist
 * @showClassIcons()：顯示icon資訊在左側欄位中
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 */
...
/**
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 * ShowDeivceStatus()功能為:對於地圖上的每個icon，都發送request到server，並且根據server的response來改變icon顏色（濾鏡）
...
/**
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 * SelectIcon()功能為：當icon button被按下時觸發
 * 滑鼠會變成icon的樣子，以便把icon插在map上
 * 選取的icon是按下的按鈕名稱
 * 
 * @Cancel()：按下取消icon選定狀態
 * @SetIconbyMouse(e,icon)：放置icon在鼠標點選的區域
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 */
...
function SelectIcon(icon){
    ...
    // 設定container之點擊事件
    container.onmousedown = function(e){SetIconbyMouse(e,icon);};
}
 ...
 * 控制css，輸出監控URL畫面控制區域
 * 
 * @ScreenZoomIn()：以正常畫面大小輸出
 * @ScreenZoomOut()：以放大畫面輸出
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 */
 ...
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 * UpdateIconList()功能：
 * 通過Node.js做前後端資訊交互，向服務器本地上傳Map、Icon最新資訊，
 * 以送出表單方式，
 * 更新本地json檔案
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 */
 ...
 * ShowIconList()功能：
 * 舊的顯示iconlist的方法
 * 這個函式目前沒有在使用，替代方法為ShowClassList()
 * -------------------------------------------------------------------------------------------------------------------------------------------------
 */
 ...
 */
 ...
 $('#add').click(function() {
    ...
    backimg.src=`./icon/default.jpg` //改變背景圖片之src
});
